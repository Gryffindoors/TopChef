...
export default function Navbar() {
    ...
    function openCart() {
        ...
        setMenuOpen(false); // Close menu if it was open
    }
    ...
    return (
        <>
            ...
            {cartCount > 0 && (
                <button
                    onClick={openCart}
                    className="md:hidden fixed bottom-6 left-6 z-[60] size-16 bg-red-600 text-white rounded-full shadow-[0_0_20px_rgba(220,38,38,0.5)] flex items-center justify-center animate-in zoom-in slide-in-from-bottom-10 duration-300 active:scale-90"
                    aria-label="Open Cart"
                >
                    <div className="relative">
                        <ShoppingCart size={28} />
                        <span className="absolute -top-3 -right-3 bg-white text-red-600 text-[10px] size-6 flex items-center justify-center rounded-full font-black border-2 border-red-600">
                            {cartCount}
                        </span>
                    </div>
                </button>
